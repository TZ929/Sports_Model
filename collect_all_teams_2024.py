#!/usr/bin/env python3
"""
Collect 2023-2024 season game stats for all teams in the database.
"""
...
class AllTeamsCollector:
    """Collect game stats for all teams in the database."""
    ...
    def collect_all_teams_data(self):
        ...
        logger.info("Starting comprehensive 2023-2024 season data collection...")
...
def main():
    """Collect 2023-2024 season data for all teams."""
    
    logger.info("Starting comprehensive 2023-2024 season data collection...")
    collector = AllTeamsCollector()
